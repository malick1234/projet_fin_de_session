    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center text-center">
            <div class="d-flex flex-column col-sm-8">
                ...
                <div class="p-1">Description: <?= $row['DescriptionComplete'] ?></div>
                <div class="p-1">
                    <?php if ($row['Etat'] == 1) { ?>
                        État: Actif
                ...
                <div class="p-1">
                        <div class="form-group">
                            ...
                            <a href="MiseAJourAnnonce.php?id=<?= $row['NoAnnonce'] ?>" class="btn btn-secondary">Modifier</a>
                                <a href="retirerAnnonce.php?id=<?= $row['NoAnnonce'] ?>" class="btn btn-secondary">Retirer</a>
                            </div>
                        </div>
                </div>
            </div>
